...
○ 특징
   ...
   -인터페이스를 implements한 클래스는 인터페이스의 모든 메소드를 Overriding해야 한다.
...
public class Test112
{
	...
	{
		//Demo ob = new Demo();	//--불가능
		// 인터페이스 대상으로는 인스턴스 생성 불가
		...
		// 인스턴스 생성 여부와 관계 없이 static 변수를 불러오기 때문에 가능

		// Demo.a = 30;		//--fianl이기 때문에 불가능
	}
}

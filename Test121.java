...
○ import문
   ...
   ※ JDK 1.5부터는 import 다음에 『static』 키워드를 붙임으로써
	  ...
	  모든 접근 가능한 메소드와 멤버 변수들은 접두사(ob, sc, br 등)를 붙이지 않고
	  사용하는 것이 가능하다.
...
public class Test121
{
	...
	*/
	public static void main(String[] args)
	{
		...
		//System.out.println(ob.action());	//--에러 발생
		// 해당 클래스에 action()이라는 메소드가 정의되어 있지 않기 때문

		System.out.println(ob.toString());	//--Test121@15db9742
		// 클래스명@해시코드
		// 자바는 메모리값에 직접적인 접근을 절대 허용하지 않기 때문에 메모리주소가 아니라 해시코드임
		// 자바가 스스로 객체를 구분하기 위해 임의로 부여하는 식별 번호

		System.out.println(ob);	//--Test121@15db9742

...
○ 오토 박싱(Auto-Boxing)과 오토 언박싱(Auto-Unboxing)
   ...
   하지만, JDK 1.5부터 레퍼런스 형과 기본 자료형이 다음과 같이 형 변환 가능하게 되었다.
   ...
   이는 JDK 1.5 이후 추가된 오토 박싱과 오토 언박싱이라는 기능으로 가능해진 것이다.
*/
...
public class Test125
{
	public static void main(String[] args)
	{
		...
		b = c;	//--Integer형 데이터(객체)를 int형 변수에 담기 (오토 언박싱)
		b = c.intValue();	//--(언박싱)

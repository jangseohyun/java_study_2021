...
○ 생성자
   -원형
	...
	→ 주어진 문자열 str을 단어로 분리하는 객체를 생성하며
	   ...
	   만약 returnDelims가 true라면 공백(구분) 문자도
	   분리된 유효한 데이터로 간주한다.
*/
...
public class Test135
{
	public static void main(String[] args) throws IOException
	{
		...
		strTemp = br.readLine();	//--"사과,딸기,바나나,복숭아"

		// StringTokenizer 클래스 인스턴스 생성
		StringTokenizer st = new StringTokenizer(strTemp, ",");
		// strTemp를 대상 문자열로, 『,』를 구분자로 함
		...
		// 『hasMoreTokens()』: 사용할 수 있는 토큰이 남아있는 경우 true를 반환
		//                      더이상 사용할 토큰이 남아있지 않은 경우 false를 반환
		//                      확인 결과만 반환할 뿐

		// 『nextToken()』: 다음 토큰을 얻어온다.

...
○ 벡터(Vector)
   ...
   데이터 요소를 가질 수 있으며, 데이터가 가득 차면 자동으로 저장 영역을 늘려주게 된다.
   ...
   시퀀스 개념의 인덱스 값을 이용하여 자료구조의 임의의 지점에서 저장 및 접근이 가능하다.
...
public class Test153
{
	...
	public static void main(String[] args)
	{
		...
		System.out.println("첫 번째 요소: "+str);	//--첫 번째 요소: 검정
		// 요소 접근 이후 제거되지 않음

		// get()
		str = (String)v.get(1);
		System.out.println("두 번째 요소: "+str);	//--두 번째 요소: 노랑
		str = (String)v.get(0);
		System.out.println("첫 번째 요소: "+str);	//--첫 번째 요소: 검정
